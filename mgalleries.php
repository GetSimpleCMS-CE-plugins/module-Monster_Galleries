...
#<?php echo $uid ?> .gal-btn:hover { background: #783CB8; }
...
<div id="<?php echo $uid ?>">
    <h3><svg xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle;" width="24" height="24" viewBox="0 0 36 36"><rect width="36" height="36" fill="none"/><path fill="currentColor" d="M30.14 3a1 1 0 0 0-1-1h-22a1 1 0 0 0-1 1v1h24Z" class="clr-i-solid clr-i-solid-path-1"/><path fill="currentColor" d="M32.12 7a1 1 0 0 0-1-1h-26a1 1 0 0 0-1 1v1h28Z" class="clr-i-solid clr-i-solid-path-2"/><path fill="currentColor" d="M32.12 10H3.88A1.88 1.88 0 0 0 2 11.88v18.24A1.88 1.88 0 0 0 3.88 32h28.24A1.88 1.88 0 0 0 34 30.12V11.88A1.88 1.88 0 0 0 32.12 10M8.56 13.45a3 3 0 1 1-3 3a3 3 0 0 1 3-3M30 28H6l7.46-7.47a.71.71 0 0 1 1 0l3.68 3.68L23.21 19a.71.71 0 0 1 1 0L30 24.79Z" class="clr-i-solid clr-i-solid-path-3"/><path fill="none" d="M0 0h36v36H0z"/></svg> <?php echo $i18n_m('mg_lang_Galleries'); ?></h3>

    <?php if (!$plugin_ok): ?>
        <p class="gal-empty">⚠ <?php echo $i18n_m('mg_lang_plugin_not_active'); ?>.</p>
    <?php elseif (empty($gallery_files)): ?>
        <p class="gal-empty"><?php echo $i18n_m('mg_lang_No_galleries'); ?>.</p>
    <?php else: ?>
    <table class="gal-table">
        <tr>
            <th><?php echo $i18n_m('mg_lang_Title'); ?></th>
            <th style="text-align:center;"><?php echo $i18n_m('mg_lang_Action'); ?></th>
        </tr>
